...
public class ItemParser {
    ...
    private static final Pattern ITEM_PATTERN = Pattern.compile("(\\d+)\\s(.+)\\sat\\s([0-9]+(?:\\.[0-9]+)?)");
    ...
    public String[] buildMatch(String inputLine){
    ...
    public Item parseItem(String[] item){
        ...
        return new Item(item[1], Double.parseDouble(item[2]), isImported, type, Integer.parseInt(item[0]));
